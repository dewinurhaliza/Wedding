...
<body>
    ...
    <br><br><br><br>
    <div>
        <h1 style="font-size: 32px; text-align: center; font-weight: bold;">Make Up Pernikahan Adat</h1><br>
        <div class="tambah"><a href="create-makeup.php"><i class="bi bi-plus-circle-fill"> </i>  Tambah Data</a></div>
    </div>
    <table>
        <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<span style='color: #294B29; display: block; margin-bottom: 5px;'>" . $row['jenis_makeup'] . "</span><br>";
                echo "<a href='update-makeup.php?id=" . $row['id'] . "' class='aksi edit'><i class='bi bi-pencil-square'></i></a>";
                echo "<a href='delete-makeup.php?id=" . $row['id'] . "' class='aksi delete' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\"><i class='bi bi-trash3-fill'></i></a>";
                echo "</div>";
                echo "</td>";
                $count++;
                if ($count % 5 == 0) {
